...
const suggestedActions = [
    {
  "title": "اعطيني نظرة عامة عن بنك فلسطين",
  "label": "",
  "action": "أعطني نظرة عامة شاملة ومفصلة عن بنك فلسطين، تشمل تاريخه، رسالته، خدماته للأفراد والشركات، التحول الرقمي، إدارته، استثماراته، أنشطته في المسؤولية الاجتماعية، التوسع الدولي، ومعلومات الاتصال. ."
    }
,
    {
